...
/* ===== NUMBER ANIMATION ENHANCEMENTS ===== */
.stat h3,
.founder-stats .stat-item h3,
.count-animate {
  transition: all 0.3s ease;
  display: inline-block;
}

/* Slight pulse animation when numbers change */
...
.stat h3.animated,
.founder-stats .stat-item h3.animated {
  animation: numberPulse 0.5s ease;
}

/* Glow effect on numbers when they appear */
.stat h3,
.founder-stats .stat-item h3 {
  position: relative;
}
...
.stat h3::after,
.founder-stats .stat-item h3::after {
  content: '';
  position: absolute;
  bottom: -2px;
  left: 0;
...
.stat:hover h3::after,
.founder-stats .stat-item:hover h3::after {
  width: 100%;
}

/* Subtle number glow on hover */
.stat:hover h3,
.founder-stats .stat-item:hover h3 {

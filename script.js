...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // ============================================
// NEWSLETTER FORM - ConvertKit Integration
// ============================================
document.addEventListener('DOMContentLoaded', function() {
  ...
  subscribeBtn.addEventListener('click', async function() {
    ...
    try {
      // 🔴 IMPORTANT: Replace YOUR_FORM_UID with your actual UID from Step 1
      const formUid = 'YOUR_FORM_UID'; // Example: abc123def
      ...
      if (response.ok) {
        ...
        if (data.error && data.error.toLowerCase().includes('already subscribed')) {
          statusDiv.innerHTML = `
            <div style="
              padding: 16px 20px;
